...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.ListElementGenerator;
...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.TableIdElementGenerator;
...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    private void addEmptyLine(XmlElement element) {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        String namespace = context.getJavaModelGeneratorConfiguration().getTargetPackage() + "."
    ...
    protected void addTableIdElement(XmlElement parentElement) {

        AbstractXmlElementGenerator elementGenerator = new TableIdElementGenerator();
        initializeAndExecuteGenerator(elementGenerator, parentElement);
