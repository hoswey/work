...
public class DefaultCommentGenerator implements CommentGenerator {
    ...
    public void addJavaFileComment(CompilationUnit compilationUnit) {
        ...
        compilationUnit
                .addFileCommentLine("/**                                                                            ");
        compilationUnit
                .addFileCommentLine(" * Copyright: 2014 Duopay, all rights reserved. Duopay PROPRIETARY/CONFIDENTIAL");
        compilationUnit
                .addFileCommentLine(" *            Use is subject to license terms.                                 ");
        compilationUnit
                .addFileCommentLine(" * Company:   System                                                           ");
        compilationUnit
                .addFileCommentLine(" * @author:   System                                                           ");
        compilationUnit
                .addFileCommentLine(" * @version:  1.0                                                              ");
        compilationUnit.addFileCommentLine(" * Create at: " + now
                + "                                                    ");
        compilationUnit
                .addFileCommentLine(" *                                                                             ");
        compilationUnit
    ...
    public void addClassComment(InnerClass innerClass, IntrospectedTable introspectedTable) {
        ...
        innerClass.addJavaDocLine("/**"); //$NON-NLS-1$ 
        innerClass.addJavaDocLine(" * 该实体bean对应数据库表" + introspectedTable.getFullyQualifiedTable().toString());
        innerClass.addJavaDocLine(" */"); //$NON-NLS-1$
    }
    ...
    public void addFieldComment(Field field, IntrospectedTable introspectedTable, IntrospectedColumn introspectedColumn) {
        ...
        */
        ...
        if (remark != null && !remark.equals("")) {
            field.addJavaDocLine("/**"); //$NON-NLS-1$
            field.addJavaDocLine(" * " + remark); //$NON-NLS-1$
            field.addJavaDocLine("*/");
        }
        // addJavadocTag(field, false);
